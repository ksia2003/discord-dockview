...
export function WebBody() {
    ...
    useEffect(() => {
        ...
        // Publish up front and again at dom-ready so the toolbar always targets the
        // live guest element.
    ...
    const webviewProps: Record<string, any> = {
        ...
        // Let the guest ask for popups; the DockView webview boundary in main routes
        // HTTP(S) popup targets to the OS browser and denies the guest window.
