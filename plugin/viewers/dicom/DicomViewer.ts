 ...
 * "dicom|<cdn-url>" (set by detectType at open time); sourceType/sourceUrl stay intact
 * while renderType/renderUrl park the blob so a restore re-points the <img>. The restore
