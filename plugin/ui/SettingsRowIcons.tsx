 ...
 * Viewers=eye, Performance=gauge, Privacy=shield, Profiles=people,
...
const GLYPHS: Record<string, El[]> = {
    ...
    // Profiles — two people (accounts).
    profiles: [
        ["circle", { cx: 9, cy: 8.5, r: 3, fill: "none", stroke: "currentColor", strokeWidth: 1.7 }],
        S({ d: "M3.5 19a5.5 5.5 0 0 1 11 0" }),
        S({ d: "M16 5.6a3 3 0 0 1 0 5.8" }),
        S({ d: "M16.5 13.2a5.5 5.5 0 0 1 4 5.8" })
    ],
...
export const ROW_ICONS = {
    ...
    profiles: makeIcon(GLYPHS.profiles),
