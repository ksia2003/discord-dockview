...
import { invokeDockviewRuntime, readDockviewRendererScript } from "./dockviewRuntime";
...
handleSync(IpcEvents.GET_DOCKVIEW_RENDERER_SCRIPT, readDockviewRendererScript);
handle(IpcEvents.DOCKVIEW_INVOKE, (event, method: string, args: unknown[]) =>
    invokeDockviewRuntime(event, method, args)
);
