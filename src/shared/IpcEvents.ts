...
export const enum IpcEvents {
    ...
    GET_DOCKVIEW_RENDERER_SCRIPT = "DV_GET_RENDERER_SCRIPT",
    ...
    SHELL_UPDATE_INFO = "VCD_SHELL_UPDATE_INFO",
    SHELL_UPDATE_VERSION = "VCD_SHELL_UPDATE_VERSION",
    SHELL_UPDATE_APPLY = "VCD_SHELL_UPDATE_APPLY",

    DOCKVIEW_READ_INSTALLED_VERSION = "DV_READ_INSTALLED_VERSION",
    DOCKVIEW_READ_CHUNK = "DV_READ_CHUNK",
    DOCKVIEW_CONVERT_ATTACHMENT = "DV_CONVERT_ATTACHMENT",
    DOCKVIEW_DISCOVER_MANIFEST = "DV_DISCOVER_MANIFEST",
    DOCKVIEW_APPLY_UPDATE = "DV_APPLY_UPDATE",
